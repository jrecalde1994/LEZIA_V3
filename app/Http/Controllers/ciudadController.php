...
class ciudadController extends AppBaseController
{
    ...
    public function store(CreateciudadRequest $request)
    {
        ...
        Flash::success('Ciudad ha sido guardado correctamente.');
    ...
    public function show($id)
    {
        ...
        if (empty($ciudad)) {
            Flash::error('Ciudad no se ha encontrado.');
    ...
    public function update($id, UpdateciudadRequest $request)
    {
        ...
        Flash::success('Ciudad ha sido modificado correctamente.');
    ...
    public function destroy($id)
    {
        ...
        Flash::success('Ciudad ha sido borrado correctamente.');
